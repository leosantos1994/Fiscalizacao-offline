...
namespace Fiscalizacao
{
    public partial class frmMenu : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                var sincronizador = new Fiscalizacao.DAO.SincronizarBase();
                sincronizador.Iniciar(Properties.Settings.Default.URL, Properties.Settings.Default.Usuario,
                    Properties.Settings.Default.Senha);

                sincronizador.IniciarMarciel(Properties.Settings.Default.URL, Properties.Settings.Default.Usuario,
                    Properties.Settings.Default.Senha);
